...
#define RES 10000.0 // сопротивление попутного резистора
#define T0 25.0 // номинальная температура
#define T_RES0 10000.0 // сопротивление терморезистора при T0
#define B_COF 3650.0 // Бета коэфицент
#define V_IN 5.0 //напряжение на терморезисторе
